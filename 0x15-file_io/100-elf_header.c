...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	check_elf(elfHeader->e_ident);
	printf("ELF Header:\n");
	print_magic(elfHeader->e_ident);
	print_class(elfHeader->e_ident);
	print_data(elfHeader->e_ident);
	print_version(elfHeader->e_ident);
	print_osabi(elfHeader->e_ident);
	print_abi(elfHeader->e_ident);
	print_type(elfHeader->e_type, elfHeader->e_ident);
	print_entry(elfHeader->e_entry, elfHeader->e_ident);
